...
public class KThread {
    ...
    public static void finish() {
        ...
        //while-loop to check threadQueue to remove anyone that is waiting
        //threadQueue.nextThread().ready()
        KThread thread = KThread.currentThread().threadQueue.nextThread();
        while (thread != null) {
            thread.ready();
            thread = KThread.currentThread().threadQueue.nextThread();
        }
    ...
    private ThreadQueue threadQueue = ThreadedKernel.scheduler.newThreadQueue(true);
}
